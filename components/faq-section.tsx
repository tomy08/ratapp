...
export function FAQSection() {
  const faqs = [
    {
      question:
        '¿Cómo verifico que mi hijo realmente asistió a clase mediante la app?',
      answer:
    ...
    {
      question:
        '¿Qué necesito para que mi institución educativa pueda comenzar a usar RatApp?',
      answer:
    ...
    {
      question:
        '¿La aplicación tiene costo para los padres o solo para la academia?',
      answer:
