      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground text-pretty mb-8 max-w-2xl mx-auto leading-relaxed">
            RatApp revoluciona el control de asistencia educativa con tecnología avanzada, proporcionando transparencia
            total para academias, padres y estudiantes.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground">Confirma la presencia física del estudiante en el aula</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground">Plataforma confiable con el aval del gobierno</p>
            </div>
          </div>
        </div>
      </div>
